...
class UsersController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = User::with(['role', 'roles'])->select(sprintf('%s.*', (new User)->table));
            ...
            $table->rawColumns(['actions', 'placeholder', 'role', 'roles', 'profile_picture']);
    ...
    public function show(User $user)
    {
        ...
        $user->load('role', 'roles', 'userDocuments');
