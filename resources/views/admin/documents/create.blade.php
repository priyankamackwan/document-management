...
<div class="card">
    ...
    @endif
    <div class="card-body">
        <form method="POST" action="{{ route("admin.documents.store") }}" enctype="multipart/form-data"  novalidate>
            @csrf
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('document_type_id') ? 'is-invalid' : '' }}" name="document_type_id" id="document_type_id"  required>
                    @foreach($documentType as $id => $dtype)
                    <option value="{{ $id }}" {{ old('document_type_id') == $id ? 'selected' : '' }}>{{ $dtype }}</option>    
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('policy_owner') ? 'is-invalid' : '' }}" type="text" name="policy_owner" id="policy_owner" value="{{ old('policy_owner', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('maturity_date') ? 'is-invalid' : '' }}" type="text" name="maturity_date" id="maturity_date" value="{{ old('maturity_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('maturity_amount') ? 'is-invalid' : '' }}" type="number" name="maturity_amount" id="maturity_amount" value="{{ old('maturity_amount', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('premium_payment_amount') ? 'is-invalid' : '' }}" type="number" name="premium_payment_amount" id="premium_payment_amount" value="{{ old('premium_payment_amount', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('premium_payment_duration') ? 'is-invalid' : '' }}" name="premium_payment_duration" id="premium_payment_duration">
                    ...
                    @foreach(App\Models\Document::PREMIUM_PAYMENT_DURATION_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('premium_payment_duration', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <label>{{ trans('cruds.document.fields.premium_payment_date') }}</label>
                <input class="form-control date {{ $errors->has('premium_payment_date') ? 'is-invalid' : '' }}" type="text" name="premium_payment_date" id="premium_payment_date" value="{{ old('premium_payment_date') }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Document::IS_REMINDER_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('is_reminder') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="is_reminder_{{ $key }}" name="is_reminder" value="{{ $key }}" {{ old('is_reminder', '') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('policy_purchased_from') ? 'is-invalid' : '' }}" type="text" name="policy_purchased_from" id="policy_purchased_from" value="{{ old('policy_purchased_from', '') }}">
